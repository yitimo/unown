...
loadWebAssembly.supported = typeof WXWebAssembly !== 'undefined'
...
function loadWebAssembly (opts) {
  ...
  function onload (cb) {
    ...
    try {
      ...
      setup({instance: WXWebAssembly.instantiate('/pages/index/base64/base64.wasm', imp)})
      
    //   setup({instance: WXWebAssembly.instantiate('/pages/index/base64/stopwatch.wasm.br', imp)})
    } catch (err) {
        console.log('???2', err)
      ready = WXWebAssembly.instantiate(wasm, imp).then(setup)
    }
